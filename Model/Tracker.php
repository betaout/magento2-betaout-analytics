...
namespace Betaout\Analytics\Model;
...
class Tracker {
     ...
     * @return void
     * */
    public function __construct(\Betaout\Analytics\Helper\Data $dataHelper) {
    ...
    public function setApiKey() {
        $this->apiKey= $this->_dataHelper->getApiKey();
    }
    ...
    public function setProjectId() {
        $this->projectId = $this->_dataHelper->getProjectId();
    }
...
// return $this;
    ...
    public function setOtt() {
        $this->ott = $this->_dataHelper->getToken();
    }
    ...
    public function makeParams($params = false) {
        ...
        {
            $params['identifiers']=$this->_dataHelper->getCustomerIdentity();
